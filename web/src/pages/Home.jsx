    ...
    <main className="page">
      ...
      <p className="sub">
        {loading
          ? '불러오는 중…'
          : activePack
            ? `현재 활성 팩: ${activePack.name} · 출제 가능한 문제 ${activePack.ready_count}개` +
              (activePack.question_count > activePack.ready_count
                ? ` (채점 기준 없는 ${activePack.question_count - activePack.ready_count}개 제외)`
                : '')
      ...
      <div className="choice-grid">
        <button
          ...
          disabled={!activePack || activePack.ready_count === 0}
        >
